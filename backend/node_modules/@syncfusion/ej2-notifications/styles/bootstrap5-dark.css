...
.e-message .e-msg-close-icon:hover, .e-message .e-msg-close-icon:focus {
  ...
  -webkit-box-shadow: 0 0 0 2px rgba(173, 181, 189, 0.12);
          box-shadow: 0 0 0 2px rgba(173, 181, 189, 0.12);
  border-radius: 50%;
}
.e-message.e-success {
  background-color: rgb(9.0625, 48.9375, 30.45);
  border-color: rgb(10.65625, 57.54375, 35.805);
  color: #2ed889;
}
...
.e-message.e-warning {
  ...
  border-color: rgb(149.8, 112.35, 0);
  color: rgb(255, 237.625, 185.5);
}
...
.e-message.e-info {
  background-color: rgb(5.1383399209, 79.8418972332, 94.8616600791);
  border-color: rgb(5.9245059289, 92.0577075099, 109.3754940711);
  color: rgb(132.1541501976, 228.895256917, 248.3458498024);
}
...
.e-message.e-error {
  ...
  border-color: rgb(102.2784810127, 17.7215189873, 25.8227848101);
  color: rgb(250.1265822785, 226.8734177215, 229.1012658228);
}
.e-message.e-error .e-msg-icon {
  color: rgb(250.1265822785, 226.8734177215, 229.1012658228) !important; /* stylelint-disable-line declaration-no-important */
}
...
.e-message.e-bigger .e-msg-close-icon:focus {
  -webkit-box-shadow: 0 0 0 4px rgba(173, 181, 189, 0.12);
          box-shadow: 0 0 0 4px rgba(173, 181, 189, 0.12);
}
