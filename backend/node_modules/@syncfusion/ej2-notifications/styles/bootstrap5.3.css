...
.e-badge.e-badge-ghost.e-badge-secondary {
  background-color: transparent;
  border: 1px solid var(--color-sf-secondary);
...
.e-badge.e-badge-ghost.e-badge-light {
  ...
  color: var(--color-sf-badge-light-bg-color);
}
...
.e-message.e-filled .e-msg-close-icon:hover, .e-message.e-filled .e-msg-close-icon:focus {
  ...
  -webkit-box-shadow: 0 0 0 2px rgba(var(--color-sf-msg-close-icon-color-alt2), 0.12);
...
.e-message.e-filled.e-warning .e-msg-close-icon:hover, .e-message.e-filled.e-warning .e-msg-close-icon:focus {
  background-color: rgba(var(--color-sf-msg-warning-icon-color-alt2), 0.12);
  -webkit-box-shadow: 0 0 0 2px rgba(var(--color-sf-msg-warning-icon-color-alt2), 0.12);
          box-shadow: 0 0 0 2px rgba(var(--color-sf-msg-warning-icon-color-alt2), 0.12);
}
...
.e-message.e-bigger.e-filled .e-msg-close-icon:focus {
  -webkit-box-shadow: 0 0 0 4px rgba(var(--color-sf-msg-close-icon-color-alt2), 0.12);
...
.e-message.e-bigger.e-filled.e-warning .e-msg-close-icon:focus {
  -webkit-box-shadow: 0 0 0 4px rgba(var(--color-sf-msg-warning-icon-color-alt2), 0.12);
          box-shadow: 0 0 0 4px rgba(var(--color-sf-msg-warning-icon-color-alt2), 0.12);
}
